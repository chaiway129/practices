    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><img src="<?php echo base_url().$_SESSION['all']['profile_img']; ?>" class="img-circle" width="80"></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
                ...
                <li><a href="<?php echo site_url();?>/view_admin">View Subject</a></li>
