...
<!-- // main page start -->
        <section class="banner">
        	<div class="banner-img"><img src="<?php echo base_url(); ?>assets/frontend/images/banner/banner-img1.jpg" alt=""></div>
            	...
            	<div class="row">
                	<div class="col-md-4 col-sm-6">
                    	<div class="course-box">
                        	<div class="img">
                            	<img src="<?php echo base_url(); ?>assets/frontend/images/courses/courses-img1.jpg" alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                    	<div class="course-box">
                        	<div class="img">
                            	<img src="<?php echo base_url(); ?>assets/frontend/images/courses/courses-img2.jpg" alt="">
                                <div class="course-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                    	<div class="course-box">
                        	<div class="img">
                            	<img src="<?php echo base_url(); ?>assets/frontend/images/courses/courses-img3.jpg" alt="">
                                <div class="course-info">
                                	<div class="date"><i class="fa fa-calendar"></i>17-09-2016</div>
                                    <div class="date"><i class="fa fa-clock-o"></i>1 Days </div>
                                    <div class="favorite"><a href="#"><i class="fa fa-heart-o"></i></a></div>
        ...
        <section class="preparation">
        	<div class="container">
                ...
                <div class="preparation-view">
                	<div class="item">
                    	<div class="icon"><img src="images/preparation-icon1.png" alt=""></div>
                    ...
                    <div class="item">
                    	<div class="icon"><img src="images/preparation-icon2.png" alt=""></div>
        ...
        <section class="contact-block">
        	<div class="contact-form">
                ...
                <div class="form-filde">
                	<form class="has-validation-callback" action="http://115.160.244.10:8084/themeforest/academy/html/thank-you.html" method="post">
                        <div class="input-box">
