 <footer id="footer">
   ...
   <!--  <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/jquery-1.12.4.min.js"></script> -->
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/jquery.form-validator.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/placeholder.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/jquery.countdown.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/countdown-script.js"></script>
   <!--  <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/map-styleMain.js"></script>
 -->
    
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/coustem.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/bootstrap-growl.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/sweetalert2.min.js"></script>
</body>

<!-- Mirrored from 115.160.244.10:8084/themeforest/academy/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 10:53:38 GMT -->
</html>
